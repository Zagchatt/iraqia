...
var cstrLoadFreePlayer = function() {
    ...
    e && "undefined" != e && "null" != e && void 0 != e && null != e && t && "undefined" != t && "null" != t && void 0 != t && null != t || alert("Please do not remove the kaz.alwadi link. \n IT IS GOING TO BE HIDDEN ANYWAY.")
    var n = e.firstChild.nodeValue,
        a = e.href,
        r = t.firstChild.nodeValue,
        d = t.href
		console.log(a);
    if ("Free Shoutcast Hosting" != n || ["https://chat-iraq.com/", "https://chat-iraq.com/"].indexOf(a) == -1  || "Radio Stream Hosting" != r || ["https://chat-iraq.com/", "https://chat-iraq.com/"].indexOf(d) == -1) alert("Please do not remove the kaz.alwadi link.\n  IT IS GOING TO BE HIDDEN ANYWAY.")
    else {
